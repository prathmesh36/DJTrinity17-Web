...
.demo-4 .large-header {
	/*background: #f9f1e9;
	background:#3498db;
	*/background: url('http://djtrinity.in/quiz11/img/bg.jpg');
	background-position: center bottom;
	background-size: cover;
		...
		<div class="container demo-4">
			<div class="content">
                <div id="large-header" class="large-header">
                    ...
                    <h1 class="main-title"><a href="http://djtrinity.in"><img src="http://djtrinity.in/assets/main/images/logo.png" style="height: 100px;margin-right: 1em;margin-left:1em;"></a><br><span>Page Not Found</span></h1>
                </div>
