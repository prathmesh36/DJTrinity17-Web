...
<?php			
			...
			while($rows=$queryed_run->fetch_assoc())
			{						 
									 echo '<br>
										  ...
										  <ul class="collection " style=";border:1px solid black;border-radius:10px;">
											...
											<li class="collection-item"><div><b>Coordinator Name -: </b>'.$rows['coord'].'</div></li>
											<li class="collection-item"><div><b>Coordinator No. -: </b>'.$rows['coord_no'].'</div></li>
											<li class="collection-item"><div><b>Oneliner -: </b>'.$rows['one_liners'].'</div></li>
											<li class="collection-item"><div><b>Registration Form Url -: </b>'.$rows['regurl'].'</div></li>																						
										  </ul>
										  </div>
										  </div>
									 ';	
