...
@keyframes shake-crazy {
  ...
  10% {
    transform: translate(-16px, 9px) rotate(-2deg);
    opacity: 0.1;
  }
  20% {
    transform: translate(17px, 19px) rotate(3deg);
    opacity: 0.9;
  }
  30% {
    transform: translate(13px, 2px) rotate(-3deg);
    opacity: 0.4;
  }
  40% {
  ...
  70% {
    transform: translate(6px, -16px) rotate(3deg);
    opacity: 0.8;
  }
  80% {
    transform: translate(18px, 3px) rotate(0deg);
    opacity: 0.6;
  }
  90% {
