        ...
        <div id="fh5co-project">
            <div class="container" align="center" style="padding-left:15px;">
                ...
                <div class="row">				
						...
						{
						?>					  
							<div class="card col-md-4 col-sm-6 fh5co-project text-center" style="margin: 0% 0%;">
		  ...
		  <div class="modal-dialog modal-lg1">	  
			...
			<?php 
				  echo '<div class="modal-header">
					...
					<h3 class="modal-title  text-center">'.$qdata['title'].'</h3>

				  </div>';
				  echo '<div class="modal-body" style="font-size:140%;">
				    <img class="img-responsive img-rounded " style="margin:0 auto;width:100%;height:100%;" src="admin/event/eventimg/'.$qdata['id'].'.jpg">
					<hr><b>'.$qdata['descrip'].'</b><hr>
					<div class="row">
					<div class="col-xs-3 text-left" style="padding-left:3%;padding-right:0px;"><b>Date : </b></div><div class="col-xs-9 text-left" style="padding-left:0px;"><p>'.$evtdate.'</p></div></div>';
				  ...
				  if($rstime>12 || $retime>12)
				  {
					...
					if($retime==12)
						$eflag="pm";					 
					 echo '<div class="row"><div class="col-xs-3 text-left" style="padding-left:3%;padding-right:0px;"><b>Time : </b></div><div class="col-xs-9 text-left" style="padding-left:0px;"><p>'.$rstime.':'.substr($qdata['stime'],3,2).$sflag; 
					 if($qdata['etime']!="00:00:00")
					  echo ' to '.$retime.':'.substr($qdata['etime'],3,2).$eflag.'</p></div></div>';										 
				  }	
				   else
				   {
					 echo '<div class="row"><div class="col-xs-3 text-left" style="padding-left:3%;padding-right:0px;"><b>Time : </b></div><div class="col-xs-9 text-left" style="padding-left:0px;"><p>'.$rstime.':'.substr($qdata['stime'],3,2).'am '; 
					 if($qdata['etime']!="00:00:00")
					  echo 'to '.$retime.':'.substr($qdata['etime'],3,2).'am</p></div></div>';										 					   
				   }
				   if($qdata['venue']!="NA")
				  echo '<div class="row"><div class="col-xs-3" text-left" style="padding-left:3%;padding-right:0px;"><b>Venue : </b></div><div class="col-xs-9 text-left" style="padding-left:0px;"><p>'.$qdata['venue'].'</p></div></div>';
				  echo '<div class="row"><div class="col-xs-3" text-left" style="padding-left:3%;padding-right:0px;"><b>Cost : </b></div><div class="col-xs-9 text-left" style="padding-left:0px;"><p>'.$qdata['price'].'</p></div></div>';			  
				  $registerlink="https://www.google.com";
				  echo '
				  <div class="modal-footer">
				  	<!--<button type="button" class="btn btn-default" style="background:green;color:white;" onClick="location.href=\''.$registerlink.'\';">Register</button>-->.
